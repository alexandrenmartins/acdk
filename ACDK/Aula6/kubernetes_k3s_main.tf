...
# Server outputs
output "k3s-server_dns_name" {
  description = "DNS name of the Server EC2 instance"
  value       = aws_instance.k3s-server.*.public_dns
}
output "k3s-server_public_ip" {
  description = "Public IP address of the Server EC2 instance"
  value       = aws_instance.k3s-server.public_ip
}
output "k3s-server_private_ip" {
  description = "Private IP address of the Server EC2 instance"
  value       = aws_instance.k3s-server.*.private_ip
}

# Client outputs
output "k3s-client_dns_name" {
  description = "DNS name of the Client EC2 instance"
  value       = aws_instance.k3s-client.*.public_dns
}
...
output "k3s-client_private_ip" {
  description = "Private IP address of the Client EC2 instance"
  value       = aws_instance.k3s-client.*.private_ip
}
